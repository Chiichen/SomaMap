...
MyGLWidget::MyGLWidget( QWidget *parent ) : QOpenGLWidget(parent)
{
  ...
  mModelPosition = cube.GetCubePosition();
}
...
void MyGLWidget::initializeGL()
{
  ...
  mProjectionMatrix.perspective(45.0f, 16.0/9.0f, 0.1f, 100.0f);
  ...
  mTexture = new QOpenGLTexture( QImage(":/bluecube.bmp").mirrored() );
...
void MyGLWidget::paintGL(void)
{
    ...
    // in the "MVP" uniform
    for(auto &e:mModelPosition)
    {
        auto curModelMatrix = mModelMatrix;
        curModelMatrix.translate(e);
        QMatrix4x4 MVP = mProjectionMatrix * mViewMatrix  * mRotate* curModelMatrix;
        MVP.scale(0.5);
...
QVector3D MyGLWidget::getArcBallVector(int x, int y)
{
